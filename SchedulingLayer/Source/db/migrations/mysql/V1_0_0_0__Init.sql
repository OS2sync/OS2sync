CREATE TABLE queue_orgunits (
	...
	pnr                         VARCHAR(255),
	sor                         VARCHAR(255),
    bypass_cache                BOOLEAN NOT NULL DEFAULT 0,
...
CREATE TABLE success_orgunits (
	...
	transfered_timestamp        DATETIME NOT NULL DEFAULT NOW(),
...
CREATE TABLE failure_orgunits (
	...
	failed_timestamp            DATETIME NOT NULL DEFAULT NOW(),
	error						TEXT
);
...
CREATE TABLE queue_users (
    ...
    INDEX IDX_queue_users_priority (priority)
);
